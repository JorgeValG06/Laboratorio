...
class modulacionPAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "modulacionPAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulacionPAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "modulacionPAM")
        ...
        self.fs = fs = 1000
        self.w = w = 50
        self.samp_rate = samp_rate = 100*fs
        self.d3 = d3 = 50
        self.d2 = d2 = 50
        self.d1 = d1 = 50
        ...
        self._d3_range = Range(0, 1000, 10, 50, 200)
        ...
        self._d2_range = Range(0, 1000, 10, 50, 200)
        ...
        self._d1_range = Range(0, 1000, 10, 50, 200)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, d3)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 100, 1, 0, 0)
        ...
        self.connect((self.ModuladorPAM_1_1, 0), (self.blocks_delay_2, 0))
        self.connect((self.ModuladorPAM_1_2, 0), (self.blocks_delay_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModuladorPAM_1, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ModuladorPAM_1_1, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.ModuladorPAM_1_2, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.ModuladorPAM_1_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_add_xx_0, 3))
        self.connect((self.blocks_delay_0, 0), (self.qtgui_time_sink_x_0, 3))
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.set_samp_rate(100*self.fs)
    ...
    def set_w(self, w):
        self.w = w
        self.ModuladorPAM_1.set_d(self.w)
        self.ModuladorPAM_1_0.set_d(self.w)
        self.ModuladorPAM_1_1.set_d(self.w)
        self.ModuladorPAM_1_2.set_d(self.w)
    ...
    def set_d3(self, d3):
        self.d3 = d3
        self.blocks_delay_0.set_dly(self.d3)
    ...
    def set_d1(self, d1):
        self.d1 = d1
        self.blocks_delay_2.set_dly(self.d1)




def main(top_block_cls=modulacionPAM, options=None):
