...
# Title: ModulacionPMUSRP
# Author: Valeria&Jorge
...
from EnvolventeComplejaPMJ1B import EnvolventeComplejaPMJ1B  # grc-generated hier_block
...
class ModulacionPMUSRP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ModulacionPMUSRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ModulacionPMUSRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPMUSRP")
        ...
        # Blocks
        ##################################################
        self._fm_range = Range(1000, 20000, 100, 1000, 200)
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "Frecuencia mensaje", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 60, 1e-6, 60, 200)
        ...
        self.EnvolventeComplejaPMJ1B_0 = EnvolventeComplejaPMJ1B(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPMJ1B_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPMJ1B_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPMJ1B_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeComplejaPMJ1B_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.EnvolventeComplejaPMJ1B_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPMJ1B_0.set_Ac(self.Ac)




def main(top_block_cls=ModulacionPMUSRP, options=None):
