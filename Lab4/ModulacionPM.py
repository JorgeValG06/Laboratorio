...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPM")
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPMJ1B_0, 0), (self.blocks_complex_to_mag_0, 0))
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.CalculoPotencia_0, 0))
...
def main(top_block_cls=ModulacionPM, options=None):
